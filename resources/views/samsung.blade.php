      ...
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown navani">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            <a class="dropdown-item" href="#iphonesection">IPHONE</a>
            <a class="dropdown-item" href="#samsungsection">SAMSUNG</a>
            <a class="dropdown-item" href="#huaweisection">HUAWAI</a>
          </div>
        </li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-white text-center">
                <h1 class="h2change mt-5">SAMSUNG MOBILES</h1>
            </div>
        </div>
    </div>
<!-- end container -->
    ...
    <div class="row">
        <div class="col-md-4 mt-5 mb-5">
            <div class="card whitecol card3" style="width: 18rem;">
                    <img class="imgchange" src="{{$page->pic_url}}" width="286" height="300" class="card-img-top" alt="...">
                    <div class="card-body">
